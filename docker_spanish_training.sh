...
python3 evaluator.py -f output/aureg/gen/res_dev_nlo_min_first-18000.txt -t ../../../data/training.json --output-dir output/aureg/gen/ --pretrained dccuchile/bert-base-spanish-wwm-cased --language es
...
python3 evaluator.py -f output/upmlm/gen/res_dev_nlo_min_first-22000.txt -t ../../../data/training.json --output-dir output/upmlm/gen/ --pretrained dccuchile/bert-base-spanish-wwm-cased --language es
# python trainer.py -h
